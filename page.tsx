...
type Section = 'dashboard' | 'contacts' | 'calendar' | 'pipeline' | 'conversations' | 'research' | 'study' | 'mailing' | 'agent'
...
Voice Desk`
  ...
  const nav = [{ id: 'dashboard', label: 'Dashboard', icon: TrendingUp }, { id: 'contacts', label: 'Database 100', icon: Users }, { id: 'calendar', label: 'Calendario', icon: CalendarDays }, { id: 'pipeline', label: 'Flusso', icon: ChevronRight }, { id: 'conversations', label: 'Comunicazioni', icon: Upload }, { id: 'research', label: 'Ricerca guidata', icon: Search }, { id: 'study', label: 'Studio su misura', icon: Calculator }, { id: 'mailing', label: 'Mailing CCN', icon: Mail }, { id: 'agent', label: 'Agente', icon: Bot }] as const
