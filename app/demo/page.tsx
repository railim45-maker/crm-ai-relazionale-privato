...
type Section = 'dashboard' | 'contacts' | 'calendar' | 'pipeline' | 'conversations' | 'research' | 'study' | 'materials' | 'mailing' | 'agent'
...
const networkMaterials: NetworkMaterial[] = [
  {
    ...
    level: 'Interesse',
    link: 'https://voicedesk.it',
    assets: [{ label: 'Sito/demo VoiceDesk', href: 'https://voicedesk.it' }, { label: 'Messaggio WhatsApp' }, { label: 'Scheda settore da preparare sul lead' }],
