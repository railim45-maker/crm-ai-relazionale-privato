...
type Section = 'dashboard' | 'contacts' | 'calendar' | 'pipeline' | 'conversations' | 'research' | 'study' | 'netfree' | 'team' | 'investors' | 'documents' | 'materials' | 'mailing' | 'agent'
