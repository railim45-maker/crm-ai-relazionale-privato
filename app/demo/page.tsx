...
function agentAnswer(question: string, contacts: Contact[], tasks: Task[], conversations: ConversationRecord[]) {
  ...
  if (contacts.length === 0) return 'Non hai ancora caricato contatti. Parti dal pulsante “Ricarica alberghi VoiceDesk 100”, poi completa email, sito e decision maker dei lead A-list.'
