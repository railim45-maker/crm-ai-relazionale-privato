...
function agentAnswer(question: string, contacts: Contact[], tasks: Task[], conversations: ConversationRecord[]) {
  ...
  if (contacts.length === 0) return 'Non hai ancora caricato contatti. Parti dal pulsante “Carica VoiceDesk 100” per la lavorazione aziende oppure “Carica archivio NetFree 2914” per il flusso LCR/NetFree; poi completa email, sito e decision maker dei lead selezionati.'
